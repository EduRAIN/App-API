...
$router->group(['prefix' => $_ENV['APP_PREFIX']], function () use ($router) {
    ...
    $router->post('scholarship-register', 'ScholarshipController@scholarshipRegister');
    $router->get('get-scholarship-register/{userId}', 'ScholarshipController@getScholarshipRegister');
});